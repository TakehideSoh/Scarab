 ...
 * objective functions. The inherited setObjectiveFunction(...) method should
 * call addObjectiveFunction(...)
 * 
 * @author lonca
 */
public interface IMultiObjOptimizationProblem extends IOptimizationProblem {
    ...
    /**
     * @return an array containing the objective values of each objective
     *         function through the last model found.
     */
    BigInteger[] getObjectiveValues();
